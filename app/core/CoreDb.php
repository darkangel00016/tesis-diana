...
class CoreDb
{
    ...
    public function connect()
    {
        ...
        if (empty($this->host)) {
            throw new Exception('MySQL host is not set', 1);
        }
     ...
     *
     * @uses $CoreDb->setQueryOption('name');
     *
     ...
     *
     * @uses $CoreDb->where('id', 7)->where('title', 'MyTitle');
     *
     ...
     *
     * @uses $CoreDb->orWhere('id', 7)->orWhere('title', 'MyTitle');
     *
     * @param string $whereProp  The name of the database field.
     * @param mixed  $whereValue The value of the database field.
     * @param string $operator Comparison operator. Default is =
     ...
     *
     * @uses $CoreDb->having('SUM(tags) > 10')
     *
     ...
     *
     * @uses $CoreDb->orHaving('SUM(tags) > 10')
     *
     * @param string $havingProp  The name of the database field.
     * @param mixed  $havingValue The value of the database field.
     * @param string $operator Comparison operator. Default is =
     ...
     *
     * @uses $CoreDb->join('table1', 'field1 <> field2', 'LEFT')
     *
     ...
     *
     * @uses $CoreDb->orderBy('id', 'desc')->orderBy('name', 'desc');
     *
    ...
    /**
     * Method creates new CoreDb object for a subquery generation
     *
    ...
    /**
     * Method returns a copy of a CoreDb subquery object
     *
     * @return CoreDb new CoreDb object
     */
    ...
    /**
     * Get where and what function was called for query stored in CoreDb->trace
     *
