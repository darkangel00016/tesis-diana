...
/**
 * Class ModuleManagerMailEntityEstudiante
 */
class ModuleManagerMailEntityEstudiante extends CoreORM
{

    public static $prefix = "";
    public $dbTable = "estudiante";
    ...
    /**
     * ModuleManagerMailEntityEstudiante constructor.
